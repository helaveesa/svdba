                  ...
                  (remove-if #'(lambda (line)
                             ...
                             (loop :for line :in strings
                                ...
                                (progn
                                  ...
                                  (find-directive "@sort")
                                  (find-directive "@selector2")
                                  (find-directive "@selector5")
                                  ...
                                  (find-directive "@lefttitle")
                                  (find-directive "@righttitle")
                                  (find-directive "@opt0id")
                                  (find-directive "@opt1id")
                                  (find-directive "@opt2id")
                                  (find-directive "@opt3id")
                                  (find-directive "@opt4id")
                                  (find-directive "@opt0title")
                                  (find-directive "@opt1title")
                                  (find-directive "@opt2title")
                                  (find-directive "@opt3title")
                                  (find-directive "@opt4title")
                                  ;; *
